    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          _buildWidgetContainerMusicPlayer(context, mediaQueryData),
        ],
      ),
    );
  }
...
Widget _buildWidgetContainerMusicPlayer(context, mediaQueryData) {
  return Padding(
    padding: EdgeInsets.only(top: mediaQueryData.padding.top + 16.0),
    child: Column(
      children: <Widget>[
        _buildWidgetActionAppBar(context),
...
Widget _buildWidgetActionAppBar(BuildContext context) {
  return Padding(
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 36.0),
            _buildWidgetMusicInfo("Title Music"),
...
Widget _buildWidgetArtistPhoto(MediaQueryData mediaQueryData) {
  return Center(
    ...
    decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage("assets/ariana_grande_artist_photo_3.png"),
          fit: BoxFit.cover,
        )),
  ));
}
...
Widget _buildWidgetLinearProgressIndicator() {
  return SizedBox(
    ...
    child: LinearProgressIndicator(
      value: 0.3,
      valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF7D9AFF)),
...
Widget _buildWidgetMusicInfo(String title) {
  return Expanded(
    child: Column(
  ...
  return Expanded(
    child: Center(
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: <Widget>[
          Expanded(child: Icon(Icons.fast_rewind)),
          Container(
            decoration: BoxDecoration(
          ...
          Expanded(child: Icon(Icons.fast_forward))
        ],
      ),
    ),
  );
